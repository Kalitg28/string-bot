...
async def get_fsub(bot, message):
    ...
    for channel_id in not_joined:
        try:
            ...
            channel_link = "https://t.me/Indian_MV"

        buttons.append([InlineKeyboardButton(f"🍿 𝐉𝐨𝐢𝐧 𝐔𝐩𝐝𝐚𝐭𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 🍿", url=channel_link)])
